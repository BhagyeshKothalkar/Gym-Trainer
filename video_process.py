...
pose_processor = AutoProcessor.from_pretrained("usyd-community/vitpose-plus-small")
pose_model = VitPoseForPoseEstimation.from_pretrained("usyd-community/vitpose-plus-small", device_map=DEVICE)
